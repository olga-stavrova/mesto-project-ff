...
export function createCard(cardData, userData, deleteCardFunction, likeCardFunction, openImageModal) {
    ...
    //console.log(cardData.owner._id, userData._id);
    ...
    cardElement.querySelector(".likes_counter").textContent = cardData.likes.length;
